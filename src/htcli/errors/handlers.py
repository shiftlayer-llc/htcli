...
def handle_blockchain_error(error_msg: str) -> HTCLIError:
    ...
    if (
        "Inability to pay some fees" in error_msg
        or "account balance too low" in error_msg
    ):
    ...
    error_handlers = {
        "1010": (
            "Transaction failed due to insufficient funds. Please check your balance and ensure you have enough to cover the transfer amount plus fees.",
            [
                "Check your current balance: htcli wallet balance --wallet <wallet-name>",
                "Try transferring a smaller amount",
                "Transaction fees are typically around 0.001-0.01 TENSOR",
        ...
        "1014": (
            "Invalid transaction origin. Please ensure you're using the correct wallet and it has permission to transfer funds.",
            [
        ...
        "1015": (
            "Too many transaction attempts. Please wait a moment before trying again.",
            [
        ...
        "1016": (
            "No transaction providers available. Please check your network connection.",
            [
        ...
        "1017": (
            "Unsupported transaction version. Please update your client.",
            [
        ...
        "1018": (
            "Transaction weight calculation error. Please try with a different amount.",
            [
                "Try transferring a smaller amount",
        ...
        "1019": (
            "Invalid transaction format. Please check your input parameters.",
            [
        ...
        "1020": (
            "Invalid transaction proof. Please ensure your wallet is properly configured.",
            [
        ...
        "1021": (
            "Transaction is too old. Please try again with a fresh transaction.",
            [
        ...
        "1022": (
            "Transaction would exhaust available resources. Please try with a smaller amount.",
            [
                "Try transferring a smaller amount",
        ...
        "1023": (
            "Invalid transaction parameters. Please check your destination address and amount.",
            [
        ...
        "1024": (
            "Invalid transaction signer. Please ensure you're using the correct wallet and password.",
            [
        ...
        "1025": (
            "Transaction is stale. Please try again.",
            [
                "Try the transaction again",
        ...
        "1026": (
            "Transaction is from the future. Please check your system clock.",
            [
                "Check your system clock is correct",
        ...
        "1028": (
            "Invalid transaction signature. Please check your wallet credentials.",
            [
        ...
        "1029": (
            "Invalid transaction nonce. Please try again.",
            [
                "Try the transaction again",
        ...
        "1031": (
            "Transaction fee is too low. Please try with a higher fee or different amount.",
            [
                "Try transferring a smaller amount",
        ...
        "1032": (
            "Transaction fee is too high. Please try with a lower fee or different amount.",
            [
                "Try transferring a smaller amount",
                "Wait for network conditions to improve",
                "Try again later",
        ...
        "1033": (
            "Transaction tip is too high. Please try with a lower tip.",
            [
        ...
        "1034": (
            "Transaction priority is too low. Please try with a higher fee.",
            [
                "Try transferring a smaller amount",
                "Wait for network conditions to improve",
                "Try again later",
        ...
        "1035": (
            "Invalid transaction. Please check all parameters and try again.",
            [
        ...
        "1036": (
            "Invalid transaction origin. Please ensure you're using the correct wallet.",
            [
                "Verify you're using the correct wallet",
        ...
        "1037": (
            "Invalid transaction call. Please check your destination address.",
            [
                "Verify the destination address is correct",
        ...
        "1038": (
            "Transaction service unavailable. Please try again later.",
            [
        ...
        "1039": (
            "Custom transaction error. Please check your parameters and try again.",
            [
                "Verify all parameters are correct",
        ...
        "1040": (
            "Bad transaction. Please check your input and try again.",
            [
                "Verify all input parameters",
                "Check wallet configuration",
        ...
        "1041": (
            "Cannot lookup account information. Please check your destination address.",
            [
                "Verify the destination address is correct",
        ...
        "1042": (
            "No permission to perform this transaction. Please check your wallet permissions.",
            [
        ...
        "1043": (
            "Unknown transaction error. Please try again or contact support.",
            [
                "Try the transaction again",
        ...
        "1044": (
            "Wrong transaction parameters. Please check your input and try again.",
            [
                "Verify all parameters are correct",
                "Check input format",
                "Try again with correct parameters",
        ...
        "1045": (
            "Invalid transaction. Please check all parameters.",
            [
                "Verify all input parameters",
        ...
        "1046": (
            "Bad transaction. Please check your input.",
            [
        ...
        "1047": (
            "Transaction amount overflow. Please try with a smaller amount.",
            [
                "Try transferring a smaller amount",
                "Check amount limits",
        ...
        "1048": (
            "Transaction amount underflow. Please try with a larger amount.",
            [
        ...
        "1049": (
            "Transaction calculation error. Please try with different parameters.",
            [
        ...
        "1050": (
            "Out of memory error. Please try with a smaller transaction.",
            [
                "Try transferring a smaller amount",
...
def handle_and_display_error(error: Exception, operation: str = "operation") -> None:
    ...
    if any(
        ...
        for keyword in ["transfer", "transaction", "blockchain", "1010", "1014", "1015"]
    ):
